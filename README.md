...
- [ ] 프로모션 할인 세트 개수 정보를 불러온다.
- [ ] 프로모션 재고가 부족하여 일부 수량을 프로모션 혜택 없이 결제해야 하는 경우인지 확인한다.
- [ ] 프로모션 상품의 부족한 수량이 얼마인지 확인한다.
- [ ] 주문 수량이 충분하지 않은 경우를 처리한다.
- [ ] 일부 수량에 대해 정가로 결제할 것인지 묻는다.
- [ ] 프로모션 적용이 가능한 상품에 대해 고객이 해당 수량보다 적게 가져온 경우인지 확인한다,
- [ ] 필요한 수량을 추가로 가져올것인지 묻는다.
- [ ] 프로모션 적용이 가능한 상품에 대해 고객이 해당 수량보다 적게 가져온 경우를 처리한다.
